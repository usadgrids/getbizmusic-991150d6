...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BizSpot Directory — Local Business Advertising" },
      { name: "description", content: "Advertise your local business from $5/year. Reach customers all year long." },
      { name: "author", content: "BizSpot" },
      { property: "og:title", content: "BizSpot Directory — Local Business Advertising" },
      { property: "og:description", content: "Advertise your local business from $5/year. Reach customers all year long." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "BizSpot Directory — Local Business Advertising" },
      { name: "twitter:description", content: "Advertise your local business from $5/year. Reach customers all year long." },
