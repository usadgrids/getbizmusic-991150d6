...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "BizSpot Directory - National City — Nationwide USA Business Advertising" },
      ...
      { property: "og:title", content: "BizSpot Directory - National City — Nationwide USA Business Advertising" },
      { property: "og:description", content: "Advertise your National City business — $12/year intro offer (about $1/month)." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "BizSpot Directory - National City — Nationwide USA Business Advertising" },
