...
export function BizHero() {
  return (
    <header className="relative overflow-hidden bg-gradient-to-br from-[#0F2A4A] via-[#163864] to-[#0F2A4A] text-white">
      ...
      <div className="relative max-w-6xl mx-auto px-3 sm:px-4 py-3 sm:py-4 lg:py-8 text-center">
        <div className="inline-flex items-center gap-2 bg-[#D4A24C]/15 border border-[#D4A24C]/40 text-[#D4A24C] px-3 py-1 rounded-full text-[10px] sm:text-xs font-semibold mb-2 sm:mb-3 break-words">
          <Sparkles size={14} className="shrink-0" /> USADGRIDS NOVELTY ADVERTISING - A WINALL MEDIA LLC CREATIVE.
        </div>
        <div className="mx-auto max-w-3xl mb-3 sm:mb-4 bg-[#D4A24C] text-[#0F2A4A] border-2 border-[#D4A24C] rounded-xl px-3 sm:px-4 py-2 text-sm sm:text-base lg:text-lg font-semibold shadow-lg break-words">
        ...
        <p className="mt-2 sm:mt-3 text-xs sm:text-sm lg:text-base text-white/80 max-w-2xl mx-auto break-words">
