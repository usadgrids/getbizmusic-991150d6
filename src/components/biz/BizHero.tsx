...
export function BizHero() {
  return (
    <header className="relative overflow-hidden bg-gradient-to-br from-[#0F2A4A] via-[#163864] to-[#0F2A4A] text-white">
      ...
      <div className="relative max-w-6xl mx-auto px-4 py-4 sm:py-6 lg:py-10 text-center">
        <div className="inline-flex items-center gap-2 bg-[#D4A24C]/15 border border-[#D4A24C]/40 text-[#D4A24C] px-3 py-1 rounded-full text-[10px] sm:text-xs font-semibold mb-3 sm:mb-4">
          <Sparkles size={14} /> USADGRIDS NOVELTY ADVERTISING - A WINALL MEDIA LLC CREATIVE.
        </div>
        <div className="mx-auto max-w-3xl mb-4 sm:mb-5 bg-[#D4A24C] text-[#0F2A4A] border-2 border-[#D4A24C] rounded-xl px-4 py-2 sm:py-3 text-sm sm:text-base lg:text-lg font-semibold shadow-lg">
        ...
        <p className="mt-3 sm:mt-4 text-sm sm:text-base lg:text-lg text-white/80 max-w-2xl mx-auto">
        ...
        <div className="mt-5 sm:mt-7 flex flex-wrap justify-center gap-3">
          <Link
            to="/submit"
            className="bg-[#D4A24C] text-[#0F2A4A] font-semibold px-5 sm:px-6 py-2.5 sm:py-3 rounded-md hover:bg-[#e0b266] transition-colors shadow-lg text-sm sm:text-base"
          >
